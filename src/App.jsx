...
import { 
  ...
  updateDoc, doc, setDoc, serverTimestamp, orderBy, deleteDoc, getDocs 
...
import { 
  ...
  Stethoscope, Palmtree, Filter, CalendarPlus, KeyRound, Archive, FileText, PlayCircle
} from 'lucide-react';
...
export default function LeavePlatform() {
  ...
  useEffect(() => {
    ...
    // Audit Logs Fetching (Admin Only really, but we fetch for simulation)
    ...
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900">
      ...
      <main className="max-w-6xl mx-auto p-6">
        ...
        {activeRole === 'ADMIN' ? (
           <div className="grid grid-cols-1 gap-8">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                 ...
                 <div className="lg:col-span-2 space-y-8">
                     ...
                     {/* 3. Policy Management (With Rollover) */}
                     <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
          ...
          // MANAGER VIEW
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
             {/* ... Manager View components (Pending, Team Coverage, Staff, History) from previous version, just updated context ... */}
             {/* Re-using the exact same components as previous, ensuring full feature parity */}
      ...
      {/* --- Shared Add/Edit Staff Modal (Unchanged) --- */}
      {isStaffModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 backdrop-blur-sm p-4 animate-in fade-in duration-200">
      ...
      {/* --- Add Department Modal (Unchanged) --- */}
      {isAddDeptOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 backdrop-blur-sm p-4 animate-in fade-in duration-200">
          <div className="bg-white w-full max-w-sm rounded-2xl shadow-2xl overflow-hidden">
            <div className="p-6 border-b border-slate-100 flex justify-between items-center">
                ...
                <div className="flex items-center gap-4">
                    ...
                    {(activeRole === 'ADMIN' || activeRole === 'MANAGER') && (
                         <div className="flex items-center gap-2 bg-slate-50 border border-slate-200 rounded-lg p-1">
                            ...
                            <select className="bg-transparent text-slate-700 text-xs font-bold outline-none p-1" value={calendarDeptFilter} onChange={(e) => setCalendarDeptFilter(e.target.value)}>
