...
import { 
  getFir// testestore, collection, addDoc, query, where, onSnapshot, 
...
// ✅ Use your real Firebase config instead of __firebase_config
...
// ✅ Simple static app id for your Firestore paths
const appId = 'leaveos';
...
export default function LeavePlatform() {
  ...
  useEffect(() => {
    const initAuth = async () => {
      try {
        // ✅ Just anonymous auth for your SPA
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900">
      {/* The rest of your JSX (nav, dashboard, modals, etc.) is unchanged */}
      {/* --- Top Navigation --- */}
      {/* ... */}
    </div>
  );
